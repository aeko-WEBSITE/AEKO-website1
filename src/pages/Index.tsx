...
const Index = () => {
  return (
    <main className="min-h-screen bg-background text-foreground overflow-x-hidden w-full relative">
      ...
      <div 
        className="fixed inset-0 bg-cover bg-center bg-no-repeat bg-fixed pointer-events-none z-0 dark:opacity-12 opacity-5"
        style={{
      ...
      {/* Additional overlay for better text readability - Theme Aware */}
      <div className="fixed inset-0 bg-background/40 dark:bg-background/30 pointer-events-none z-0" />
