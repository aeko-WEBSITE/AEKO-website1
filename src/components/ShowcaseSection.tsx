          ...
          >
            {showcaseContent.map((item, index) => {
              ...
              return (
                ...
                >
                  <div
                    className="relative overflow-hidden rounded-3xl border-4 border-border dark:border-white bg-card h-64"
                    style={{
                  ...
                  >
                    ...
                    {item.type === "chat" && (
                      <div className="w-full h-full p-4 flex flex-col gap-3 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-950/30 dark:to-pink-950/30">
                        ...
                        <div className="flex-1 flex flex-col gap-2 overflow-hidden">
                          {item.messages?.map((msg, msgIndex) => (
                            ...
                            >
                              ...
                              <div className={`max-w-[80%] rounded-lg px-3 py-2 text-xs ${msg.role === "user" ? "bg-primary text-primary-foreground" : "bg-card dark:bg-white/10 border border-border dark:border-white/20 text-foreground dark:text-white"}`}>
                                {msg.text}
                              </div>
                              {msg.role === "user" && (
                    ...
                    {/* Type Badge */}
                    <div className="absolute top-3 left-3 px-3 py-1.5 rounded-lg bg-background/90 dark:bg-black/80 backdrop-blur-sm border border-border dark:border-white/20 flex items-center gap-2 z-10">
